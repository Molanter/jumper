...
function addItems() {
  ...
  createItem(675, 50, 'coin');
  createItem(525, 300, 'coin');
  createItem(750, 250, 'coin');
  createItem(225, 250, 'coin');
  createItem(400, 150, 'poison');
  createItem(30,350,'poison');
  createItem(680, 250, 'poison');
...
function addPlatforms() {
  ...
  platforms.create(10, 400, 'platform');
  platforms.create(150, 300, 'platform');
  platforms.create(600, 300, 'platform');
  platforms.create(550, 100, 'platform2');
...
function createBadge() {
  ...
  var badge = badges.create(650, 490, 'badge');
...
window.onload = function () {
  ...
  function preload() {
    ...
    game.load.image('platform2', './assets/images/platform_2.png');
    ...
    game.load.spritesheet('poison', './assets/images/poison.png', 32, 32);
    game.load.spritesheet('star', './assets/images/star.png', 32, 32);
  }
